...
import { Loader2, Send, Trash2, Menu } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="w-64 bg-sidebar border-r border-sidebar-border flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <a
            href="/chats"
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:bg-accent hover:text-foreground"
          >
            <Menu className="h-4 w-4" />
            Chats
          </a>
                    ...
                    <CardContent className="p-0">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-muted-foreground">Gabi está pensando...</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
